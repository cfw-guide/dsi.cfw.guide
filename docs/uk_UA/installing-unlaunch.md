...
Якщо у вас немає доступу до ПК, або якщо ваш ПК працює на ChromeOS, то, будь ласка, не встановлюйте Unlaunch. A PC (running Windows, Linux, or macOS) is required to ensure the SD Card used is formatted in a way compatible with Unlaunch.
