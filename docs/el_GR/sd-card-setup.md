...
Εάν χρησιμοποιείτε λογισμικό προστασίας από ιούς, αυτό ενδέχεται να θεωρήσει αυτήν την εφαρμογή ως ιό. Πρόκειται για ψευδή προειδοποίηση, καθώς η χρήση της εφαρμογής είναι ασφαλής.
