# Εγκατάσταση του Unlaunch Standalone
...
4. Εάν θέλετε να απενεργοποιήσετε τη μουσική του μενού DSi, επιλέξτε `Disable DSi menu sound` και πατήστε το <kbd class="face">A</kbd> για απενεργοποίηση
5. Εάν θέλετε να απενεργοποιήσετε την εικόνα εκκίνησης του DSi (με το μήνυμα περί υγείας και ασφάλειας), επιλέξτε `Disable DSi menu H&S` και πατήστε το <kbd class="face">A</kbd> για απενεργοποίηση
...
Επί του παρόντος, το Unlaunch ανοίγει από προεπιλογή το μενού αρχείων του κατά την εκκίνηση, αλλά μπορείτε να το αλλάξετε για να κάνει εκκίνηση στο αρχικό μενού του DSi.
...
2. Μεταβείτε στην επιλογή `OPTIONS` και επιλέξτε `NO BUTTON`
3. Στη λίστα που ακολουθεί, επιλέξτε `Launcher`
4. Επιλέξτε `SAVE & EXIT` για να αποθηκεύσετε τις ρυθμίσεις σας και έπειτα, απενεργοποιήστε το DSi σας
