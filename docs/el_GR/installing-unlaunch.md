...
5. Εάν θέλετε να απενεργοποιήσετε τη μουσική του μενού DSi, επιλέξτε `Disable DSi menu sound` και πατήστε το <kbd class="face">A</kbd> για απενεργοποίηση
6. Εάν θέλετε να απενεργοποιήσετε την εικόνα εκκίνησης του DSi (με το μήνυμα περί υγείας και ασφάλειας), επιλέξτε `Disable DSi menu H&S` και πατήστε το <kbd class="face">A</kbd> για απενεργοποίηση
7. Εάν το Unlaunch είναι ήδη εγκατεστημένο, επιλέξτε `Uninstall unlaunch` ή `Restore launcher tmd` και πατήστε το <kbd class="face">A</kbd> μόλις ολοκληρωθεί η ενέργεια
   - Εάν θέλετε απλώς να **αφαιρέσετε** το Unlaunch, μπορείτε να σταματήσετε εδώ
8. Επιλέξτε `Install unlaunch` και πατήστε το κουμπί <kbd class="face">A</kbd>
9. Πατήστε το κουμπί <kbd class="face">A</kbd> μόλις ολοκληρωθεί η εγκατάσταση
10. Πατήστε το <kbd class="face">POWER</kbd> για να επανεκκινήσετε το σύστημά σας
