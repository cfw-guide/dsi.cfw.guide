...
Η μόνη εξαίρεση είναι μια εγκατάσταση του Unlaunch σε ένα DSi με την έκδοση συστήματος 1.4.2, η οποία δεν υποστηρίζεται επί του παρόντος από το Safe Unlaunch Installer (εξαιτίας ενός σφάλματος) και απαιτεί την ενημέρωση της κονσόλας DSi σας στην έκδοση 1.4.5.
...
- Με το TWiLight Menu++ και το AKMenu-Next, μπορείτε να πλοηγηθείτε στην κάρτα SD σας για να βρείτε και να εκτελέσετε αρχεία ROM μέσω του nds-bootstrap. Τα πλεονεκτήματα αυτών των μενού περιλαμβάνουν ένα μενού για cheat, ρυθμίσεις ανά παιχνίδι και κατάργηση των περιορισμών που φέρουν οι διεργασίες προώθησης (forwarder). Με άλλα λόγια, μπορείτε να αποθέσετε τα αρχεία ROM απευθείας και να παίξετε χωρίς καμία επιπρόσθετη ρύθμιση. Δεν υφίσταται το όριο των 39 τίτλων, δεν απαιτείται ούτε το hiyaCFW ούτε το Unlaunch και δεν υπάρχει κανένας περιορισμός για τον ελεύθερο χώρο που μπορείτε να έχετε στην κάρτα SD
...
- **AKMenu-Next** - Ακολουθήστε τις οδηγίες της [Τεκμηρίωσης του AKMenu-Next](https://coderkei.github.io/akmenu-next-docs/guides/akmenu-next/#__tabbed_1_5)
...
- Η [γεννήτρια mkey](https://mkey.nintendohomebrew.com) μπορεί να δημιουργήσει τον κωδικό που απαιτείται για την κατάργηση του γονικού ελέγχου
...
- Διαβάστε τον [οδηγό για απομιμήσεις καρτών MicroSD](https://www.flashcarts.net/microsd-fakes), ώστε να βεβαιωθείτε ότι δεν θα καταλήξετε με μια πλαστή κάρτα SD/MicroSD
