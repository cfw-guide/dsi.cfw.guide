...
- Μια επώνυμη κάρτα SD καλής ποιότητας (ή επώνυμη κάρτα MicroSD με προσαρμογέα SD). **Αυτό είναι σημαντικό, καθώς η χρήση μη αυθεντικών ή μη επώνυμων καρτών SD ενδέχεται να οδηγήσει σε ζητήματα συμβατότητας και απώλεια δεδομένων!** Για περισσότερες πληροφορίες, [δείτε αυτό το άρθρο](https://www.flashcarts.net/microsd-fakes) σχετικά με τις πλαστές κάρτες MicroSD· οι πληροφορίες του ισχύουν και για τις κάρτες SD πλήρους μεγέθους.

## Ενότητα I - Προετοιμασία

::: warning

Βεβαιωθείτε ότι η κάρτα SD σας έχει [διαμορφωθεί σωστά με βάση αυτόν τον οδηγό](sd-card-setup.html). Εάν παρακάμψετε αυτό το βήμα, ενδέχεται να αντιμετωπίσετε προβλήματα συμβατότητας με το homebrew ή μια κάρτα SD με το λάθος σύστημα αρχείων.
...
3. Αντιγράψτε το αρχείο `boot.nds` στη ρίζα της κάρτας SD σας
   - Βεβαιωθείτε ότι έχει το όνομα `boot.nds` αντί για `boot (1).nds` ή οποιοδήποτε άλλο
...
Εάν χρησιμοποιείτε το exploit χωρίς να εγκαταστήσετε το Unlaunch, η συμβατότητα με ορισμένες εφαρμογές homebrew ενδέχεται να είναι περιορισμένη. Εάν αντιμετωπίσετε προβλήματα με εφαρμογές homebrew DSi ή/και τη λειτουργία κάμερας σε παιχνίδια DSi-Enhanced, μπορείτε να επιστρέψετε σε αυτόν τον οδηγό και να αξιοποιήσετε ένα [εναλλακτικό exploit](alternate-exploits.html).
