...
5. Ha szeretnéd kikapcsolni a DSi menü zenét, válaszd a `Disable DSi menu sound` opciót és nyomjd <kbd class="face">A</kbd> gombot a kikapcsolásához
6. Ha szeretnéd kikapcsolni a DSi kezdőképernyőt (az egészségügyi üzenettel), válaszd a `Disable DSi menu H&S` opciót és nyomj <kbd class="face">A</kbd> gombot a kikapcsolásához
7. Ha az Unlaunch már telepített, válaszd az `Uninstall unlaunch` vagy a `Restore launcher tmd` opciót és nyomj <kbd class="face">A</kbd> gombot, ha kész
   - Ha csak az Unlaunch-öt szeretnéd eltávolítani, megállhatsz itt
8. Válaszd az `Install unlaunch` opciót és nyomj <kbd class="face">A</kbd> gombot
9. Nyomj <kbd class="face">A</kbd> gombot, ha a telepítés kész
10. Nyomj <kbd class="face">POWER</kbd> gombot a rendszered újraindításához
