# Az Unlaunch Standalone telepítése
...
1. A DSi Menuben indítsd el a System Settings alkalmazást (szürke ikon egy fehér csavarkulcssal)
   ...
   - Ha a verzió _nem_ `Ver 1.4.2`, menj egyenesen a [III. részhez](#section-iii-installing-unlaunch)
...
4. Érintsd meg a `Yes`-t amikor kérdi a csatlakozást az internethez és frissítéshez
   ...
   - Ha a verzió már friss, menjd egyenesen a [III. részhez](#section-iii-installing-unlaunch)
...
Jelenleg az Unlaunch alapértelmezésben a Filemenu-t indítja bootoláskor, de ez módosítható arra, hogy az eredeti DSi menüt hozza be.
...
2. Navigálj az `OPTIONS`-höz és válaszd a `NO BUTTON` opciót
3. Az ezt követő listában válaszd a `Launcher` opciót
4. Válaszd a `SAVE & EXIT` opciót a beállításaid mentéséhez, majd kapcsold ki a DSi konzolod
