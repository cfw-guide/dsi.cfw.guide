...
1. In the file navigation menu, launch `Unlaunch DSi Installer`
   - If you see two black screens after launching, download [GodMode9i](https://github.com/DS-Homebrew/GodMode9i/releases), put it's .dsi file on the SD root, rename `Unlaunch.dsi` to `Unlaunch.nds`, then launch nds-hb-menu using TWiLight Menu++, and start `Unlaunch.nds`     
