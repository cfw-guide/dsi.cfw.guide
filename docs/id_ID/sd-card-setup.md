...
Pastikan sudah mencadang isi kartu SD _SEBELUM_ mengikuti ini. Your SD card will be WIPED in the process.
...
1. Unduh dan ekstrak [arsip "h2testw"](http://www.heise.de/ct/Redaktion/bo/downloads/h2testw_1.4.zip) di mana saja di komputer
