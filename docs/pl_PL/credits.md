...
- [nathanfarlow](https://github.com/nathanfarlow): Odkrywca & deweloper exploitu w DSi Browser
- [WinterMute](https://devkitpro.org/support-devkitpro): Opiekuje się DS Homebrew toolchain i rozwija exploit ugopwn Flipnote Studio, aby stworzyć Flipnote Lenny (obsługuje wszystkie oprogramowania i regiony)
- [nocash](http://problemkaputt.de/donate.htm): Deweloper Unlaunch
- [RocketRobz](https://github.com/RocketRobz): Deweloper TWiLight Menu++ oraz GodMode9i
- [zoogie](https://github.com/zoogie): Deweloper dumpTool i zedytował Memory Pit, by wspierał wszystkie regiony i firmware
- [Plailect](https://github.com/Plailect): Stworzył oryginalny Poradnik jak zmodyfikować 3DS, z którego ten czerpał inspirację
