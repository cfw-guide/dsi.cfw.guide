...
If you do not have access to a PC, or if your PC is running ChromeOS, then please do not install Unlaunch and hiyaCFW. 需要一台個人電腦（執行 Windows、Linux 或 macOS）來確認所使用的SD卡格式與 Unlaunch 相容。
